...
export default function BracketBronce() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-red-900 py-8 px-4 sm:p-8">
      <div className="flex items-center justify-center pt-32 pb-16">
        ...
        <div className="ml-2">
          <Trophy size={24} className="mx-auto text-amber-800" />
        </div>
      </div>
